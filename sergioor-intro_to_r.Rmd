...
-   How do these counts compare to Arbuthnot's? Are they on a similar scale?
    ...
    Sample on Arbuthnot's dataset is larger
...
-   Make a plot that displays the boy-to-girl ratio for every year in the data 
    ...
    ```
    **The comparison of the dataset shows decline of male births against female births in the US**
...
-   In what year did we see the most total number of births in the U.S.? You can
   ...
   newpresent<- cbind(present,totalbirths) 
   arrange(newpresent, desc(totalbirths))
   
    
    ```

**1961 is the year with most births in the present dataset**
